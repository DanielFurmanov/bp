...
<div id="wrapper">
    ...
    <!-- Header -->
    <header id="header">
        <h1><a href="#">Блог <span style="color:#FFAE6F">ПРО</span>ЗРЕНИЕ</a></h1>
        <nav class="links">
            <ul>
        ...
        <article class="post">
            ...
            <footer style="display: flex; justify-content: right;">
                <ul class="actions" style="text-align: center">
                    <li><a href="#" class="button big">Читать подробнее</a></li>
                </ul>
            </footer>
        </article>
